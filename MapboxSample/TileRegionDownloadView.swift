    ...
    let regions = [
        OfflineRegion(
            ...
            bounds: CoordinateBounds(
                southwest: CLLocationCoordinate2D(latitude: 32.846389, longitude: -116.894832),
                northeast: CLLocationCoordinate2D(latitude: 32.85619, longitude: -116.878542)
            )
        ),
        OfflineRegion(
            id: "philadelphia-region",
            name: "Deep Run",
            bounds: CoordinateBounds(
                southwest: CLLocationCoordinate2D(latitude:  40.09638, longitude: -74.52419),
                northeast: CLLocationCoordinate2D(latitude: 40.11326, longitude: -74.48006)
            )
        ),
        OfflineRegion(
            id: "denver-region",
